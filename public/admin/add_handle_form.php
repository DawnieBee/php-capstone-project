...
// confirm form data is POST or die
if('POST' !== $_SERVER['REQUEST_METHOD'] ){
    $flash = array(
        'class' => 'flash_error',
        'message' => 'Enter info to edit.'
        );
...
if(!empty($errors)){
    ...
    header('Location: /admin/neighborhood_add.php');
    die;
}

$neighbhorhood = new NeighborhoodModel();

$hood = $neighbhorhood->add($_POST);
